...
import { addUser, removeUser } from "../features/reducers/AuthSlice";
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4">
        ...
        <nav className="space-y-2">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r mt-60 from-red-700 to-red-500 text-white rounded-lg px-4 py-2 flex items-center gap-2 hover:from-pink-600 hover:to-red-600 transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
          >
            Logout
          </button>
        </nav>
