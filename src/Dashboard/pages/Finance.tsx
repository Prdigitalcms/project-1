...
interface Transaction {
  id: string;
  type: 'earning' | 'withdrawal' | 'royalty';
  amount: number;
  description: string;
  date: string;
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600 dark:text-green-400">${currentBalance.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">${pendingEarnings.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">${maxWithdrawal.toFixed(2)}</p>
                </div>
            ...
            <form onSubmit={handleWithdrawal} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setWithdrawalRequest({ ...withdrawalRequest, amount: parseFloat(e.target.value) || 0 })}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setWithdrawalRequest({ ...withdrawalRequest, method: e.target.value as 'bank' | 'paypal' | 'stripe' })}
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-700 dark:text-white"
                  required
                >
                ...
                <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setWithdrawalRequest({ ...withdrawalRequest, paypalEmail: e.target.value })}
                      className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-700 dark:text-white"
                ...
                <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setWithdrawalRequest({ ...withdrawalRequest, stripeAccountId: e.target.value })}
                      className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-700 dark:text-white"
