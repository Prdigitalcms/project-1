...
const pricingPlans = [
  {
    ...
    features: ['Unlimited Release', '200+ Store', 'Premium Features', '48 Hours Support', 'Store Automator', 'Official Artist Channel']
  },
  {
    name: 'Lable ',
    price: '75%',
    ...
    features: ['Unlimited Artist', 'Unlimited Music Distribution', '24 Hours Support', 'Advanced Analytics', 'Social Media Integration', 'Official Artist Channel']
  },
  {
    name: 'White Lable',
    price: '80%',
    ...
    features: ['All Premium Features', "Custom Dashboard on Your Domain", 'Your Brand & Logo', 'Custom Payment Integration', 'Multi-User Management', 'Digital Store Access']
  }
];
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="p-8 border border-gray-300 dark:border-gray-800 rounded-2xl transition-transform hover:scale-105 duration-300">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 min-h-[60px]">{plan.description}</p>
